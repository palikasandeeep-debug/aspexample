<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aspexample.aspx.cs" Inherits="aspexample.aspexample" %>
   ...
   <tr>
    ...
    <asp:Label ID="lblmsg4" runat="server"></asp:Label>
       ...
       <table align="center">
               ...
               <tr>
                   <td>
               enter ur name <asp:TextBox ID="txtfname" runat="server" AutoPostBack="true" OnTextChanged="txtfname_TextChanged1" ></asp:TextBox>
...
enter  confirm password <asp:TextBox ID="txtcpass" runat="server" TextMode="Password" ></asp:TextBox>
    ...
    <%--<table align="center">
          ...
          <asp:GridView ID="gvperson" runat="server" AutoGenerateColumns="true"></asp:GridView>
                  ...
                  <h5>well come </h5> 
                  <asp:Label ID="lblstring" runat="server"></asp:Label><br /><br />
                  
              your name:   <asp:Label ID="lblfmsg" runat="server" Text="your fist name"></asp:Label><br /><br />


                password:  <asp:Label ID="lblpmsg" runat="server" Text ="your password"></asp:Label>
       </div>
    </form>
</body>
</html>
